...
public class ConfirmPaymentPayload {
    ...
    /**
     * Запрос подтверждения добавления платежа в АО "Киви"
     *
     * @param addPaymentRequest Объект AddPaymentRequest
     * @return Ответ в виде запроса в АО "Киви" в формате XML
     */
    public String buildXMLPayload(AddPaymentRequest addPaymentRequest) {
        ...
        try {
            ...
            // Create the "confirmPayment" element
            Element confirmPayment = document.createElement("confirmPayment");
            providers.appendChild(confirmPayment);
            ...
            confirmPayment.appendChild(payment);
